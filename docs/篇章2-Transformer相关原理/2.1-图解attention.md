...
1. 假设序列输入是一个句子，这个句子可以由$n$个词表示:
   ...
   $$ 。
3. 假设序列输入是一个句子，这个句子可以由$n$个词表示: ![formula](https://render.githubusercontent.com/render/math?math=sentence = \{w_1, w_2,...,w_n\})
4. 假设序列输入是一个句子，这个句子可以由$n$个词表示:  $sentence = \{w_1, w_2,...,w_n\}$ ![formula](https://render.githubusercontent.com/render/math?math=sentence = \{w_1, w_2,...,w_n\})。
5. ![formula](https://render.githubusercontent.com/render/math?math=sentence = \{w_1, w_2,...,w_n\})
